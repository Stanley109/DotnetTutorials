...
The intention of creating this repository is to refresh basic C# concepts and get used to it so that I may apply it to my Selenium Webdriver automation showcase.
I also intend it for others to learn basic C# concepts. As much as possible. I would make each concept as simple as possible.
